...
import { deletePublishers, updatePublisher } from "@/app/(admin)/publishers/actions";
...
export default async function PublisherDetailPage({
  ...
  const updateWithId = updatePublisher.bind(null, entity.id);
  const deleteWithId = deletePublishers.bind(null, [entity.id]);
